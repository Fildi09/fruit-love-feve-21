...
function denyWager(message){verdictView.textContent=message;wagerInput.classList.remove('rl-deny-4b9d537e');void wagerInput.offsetWidth;wagerInput.classList.add('rl-deny-4b9d537e');}
...
var brandEl=document.querySelector('.rl-brand-4b9d537e');var echoEl=grab('rl-echo');if(brandEl&&echoEl){echoEl.textContent=brandEl.textContent.replace(/\s+/g,' ').trim();}
